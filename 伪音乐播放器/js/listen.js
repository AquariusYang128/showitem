...
var index = 0;
var recm_list = document.querySelectorAll('.recm_list ul li')
...
var presong = function(){
    if (index == 0){
        index =audio_list.length-1;
    }else{
        index--;
    }
    audio.src = "./audio/" + audio_list[index] +  ".mp3";
    image.src = "./image/main/" + image_list[index] + ".jpg"
    songName.innerHTML = songAndSinger_list[index][0] + '<i class="iconfont icon-aixin"></i>'
    singer.innerHTML = songAndSinger_list[index][1]
}
...
/* 播放列表 */
var Open1 = false;
var playlistmusic = document.getElementById("playlistmusic");
var playlist = document.getElementById("playlist");
var songlist = document.querySelectorAll('.songlist ul li')
