...
// 轮播图的图片地址与跳转链接
let links=[
    {'image':'../image/lunbo/1.jpg','target':'#1'},
    {'image':'../image/lunbo/2.jpg','target':'#2'},
    {'image':'../image/lunbo/3.jpg','target':'#3'},
    {'image':'../image/lunbo/4.jpg','target':'#4'},
    {'image':'../image/lunbo/5.jpg','target':'#5'},
    {'image':'../image/lunbo/6.jpg','target':'#6'}
];
